...
public class BookSearchProcessorTest {
    ...
    public void searchOneWord() throws Exception {
        BookSearchProcessor<String, BaseModule> searchProcessor = new BookSearchProcessor<>(repository, module, "Gen", "авель", false);
    ...
    public void searchTwoWord() throws Exception {
        BookSearchProcessor<String, BaseModule> searchProcessor = new BookSearchProcessor<>(repository, module, "Gen", "авел каин", false);
        Map<String, String> results = searchProcessor.search();
    ...
    public void searchWithEmptyQuery() throws Exception {
        BookSearchProcessor<String, BaseModule> searchProcessor = new BookSearchProcessor<>(repository, module, "Gen", "", false);
        Map<String, String> results = searchProcessor.search();
    ...
    @Test
    public void searchWholeWordExactSingleWord() throws Exception {
        BookSearchProcessor<String, BaseModule> searchProcessor = new BookSearchProcessor<>(repository, module, "Gen", "Авель", true);
        Map<String, String> results = searchProcessor.search();
    ...
    @Test
    public void searchWholeWordExactPhrase() throws Exception {
        BookSearchProcessor<String, BaseModule> searchProcessor = new BookSearchProcessor<>(repository, module, "Gen", "голос Господа", true);
        Map<String, String> results = searchProcessor.search();

        assertThat(results.size(), equalTo(1));
        Set<String> references = results.keySet();
        assertTrue(references.contains("RST.Gen.3.8"));
    }
