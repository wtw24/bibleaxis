...
public class MultiThreadSearchProcessorTest {
    ...
    @Test
    public void search() {
        Map<String, String> results = searchProcessor.search(module, Arrays.asList("Gen", "Exo"), "бог", false);
        assertThat(results.size()).isEqualTo(76);
    }

    @Test
    public void searchBookNotFound() {
        Map<String, String> results = searchProcessor.search(module, Collections.singletonList("Sam"), "бог", false);
        assertThat(results);
