...
public class ReaderViewPresenterTest {
    ...
    public void setNightMode() {
        ...
        presenter.setNightMode(true);

        verify(preferenceHelper).setNightMode(eq(true));
        verify(view).setTextAppearance(eq(textAppearance));
    }
    ...
    @Test
    public void openLinkStringSuccess() throws Exception {
        initMocks();
